$(document).ready(function () {     
    ...
    $('#Scene20_0').addClass('visible');
	$('#Scene20_1').addClass('visible');
	$('#Scene20_2').addClass('visible');
    $('#Scene20_3').addClass('visible');
	$('#Scene20_4').addClass('visible');
	$('#Scene20_5').addClass('visible');
    $('#Scene20_6').addClass('visible');
	$('#Scene20_7').addClass('visible');
	$('#Scene20_8').addClass('visible');


/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide20_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide20_popup1').bind('touchend', function(event) {      
       document.getElementById('slide20_popup1').className='reset_slide20_popup1';
...
/*popup */ 
    $('#Sat').bind('touchend', function(event) {      
       $('#slide20_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide20_popup2').bind('touchend', function(event) {      
       document.getElementById('slide20_popup2').className='reset_slide20_popup2';

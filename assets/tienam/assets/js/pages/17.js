$(document).ready(function () {     
    ...
    $('#Scene17_0').addClass('visible');
	$('#Scene17_1').addClass('visible');
	$('#Scene17_2').addClass('visible');
    $('#Scene17_3').addClass('visible');
	$('#Scene17_4').addClass('visible');
	$('#Scene17_5').addClass('visible');
    $('#Scene17_6').addClass('visible');
	$('#Scene17_7').addClass('visible');
	$('#Scene17_8').addClass('visible');
	$('#Scene17_9').addClass('visible');
	$('#Scene17_10').addClass('visible');
	$('#Scene17_11').addClass('visible');
	$('#Scene17_12').addClass('visible');
	$('#Scene17_13').addClass('visible');
	$('#Scene17_14').addClass('visible');
    $('#Scene17_15').addClass('visible');
	$('#Scene17_16').addClass('visible');


/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide17_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide17_popup1').bind('touchend', function(event) {      
       document.getElementById('slide17_popup1').className='reset_slide17_popup1';

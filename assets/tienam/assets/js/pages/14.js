$(document).ready(function () {     
    ...
    $('#Scene14_0').addClass('visible');
	$('#Scene14_1').addClass('visible');
	$('#Scene14_2').addClass('visible');
    $('#Scene14_3').addClass('visible');
	$('#Scene14_4').addClass('visible');
	$('#Scene14_5').addClass('visible');
    $('#Scene14_6').addClass('visible');
	$('#Scene14_7').addClass('visible');
	$('#Scene14_8').addClass('visible');
	$('#Scene14_9').addClass('visible');
	$('#Scene14_10').addClass('visible');
	$('#Scene14_11').addClass('visible');
	$('#Scene14_12').addClass('visible');
	$('#Scene14_13').addClass('visible');
	$('#Scene14_14').addClass('visible');
    $('#Scene14_15').addClass('visible');


/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide14_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide14_popup1').bind('touchend', function(event) {      
       $('#background_transparent1').click();
      });
        
     $('#background_transparent1').bind('touchend', function(event) {      
         document.getElementById('slide14_popup1').className='reset_slide14_popup1';

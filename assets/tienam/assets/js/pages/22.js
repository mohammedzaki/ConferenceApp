$(document).ready(function () {     
    ...
    $('#Scene22_0').addClass('visible');
	$('#Scene22_1').addClass('visible');
	$('#Scene22_2').addClass('visible');
    $('#Scene22_3').addClass('visible');
	$('#Scene22_4').addClass('visible');
	$('#Scene22_5').addClass('visible');
    $('#Scene22_6').addClass('visible');
	$('#Scene22_7').addClass('visible');
	$('#Scene22_8').addClass('visible');
	$('#Scene22_9').addClass('visible');
	$('#Scene22_10').addClass('visible');
	$('#Scene22_11').addClass('visible');
	$('#Scene22_12').addClass('visible');
	$('#Scene22_13').addClass('visible');
	$('#Scene22_14').addClass('visible');
    $('#Scene22_15').addClass('visible');

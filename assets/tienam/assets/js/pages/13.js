$(document).ready(function () {     
    ...
    $('#Scene13_0').addClass('visible');
	$('#Scene13_1').addClass('visible');
	$('#Scene13_2').addClass('visible');
    $('#Scene13_3').addClass('visible');
	$('#Scene13_4').addClass('visible');
	$('#Scene13_5').addClass('visible');
    $('#Scene13_6').addClass('visible');
	$('#Scene13_7').addClass('visible');


/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide13_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide13_popup1').bind('touchend', function(event) {      
       $('#background_transparent1').click();
      });
        
     $('#background_transparent1').bind('touchend', function(event) {      
         document.getElementById('slide13_popup1').className='reset_slide13_popup1';

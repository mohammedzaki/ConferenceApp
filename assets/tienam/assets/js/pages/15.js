$(document).ready(function () {     
    ...
    $('#Scene15_0').addClass('visible');
	$('#Scene15_1').addClass('visible');
	$('#Scene15_2').addClass('visible');
    $('#Scene15_3').addClass('visible');
	$('#Scene15_4').addClass('visible');
	$('#Scene15_5').addClass('visible');
    $('#Scene15_6').addClass('visible');
	$('#Scene15_7').addClass('visible');
	$('#Scene15_8').addClass('visible');
	$('#Scene15_9').addClass('visible');
	$('#Scene15_10').addClass('visible');

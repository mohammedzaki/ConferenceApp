$(document).ready(function () {     
    ...
    $('#Scene18_0').addClass('visible');
	$('#Scene18_1').addClass('visible');
	$('#Scene18_2').addClass('visible');
    $('#Scene18_3').addClass('visible');
	$('#Scene18_4').addClass('visible');
	$('#Scene18_5').addClass('visible');
    $('#Scene18_6').addClass('visible');
	$('#Scene18_7').addClass('visible');
	$('#Scene18_8').addClass('visible');
...
/*popup */
    ...
    $('#Study1').bind('touchend', function(event) {      
       $('#slide19_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide19_popup2').bind('touchend', function(event) {      
       document.getElementById('slide19_popup2').className='reset_slide19_popup2';

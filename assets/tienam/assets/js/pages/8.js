$(document).ready(function () {     
    ...
    $('#Scene8_0').addClass('visible');
	$('#Scene8_1').addClass('visible');
	$('#Scene8_2').addClass('visible');
    $('#Scene8_3').addClass('visible');
	$('#Scene8_4').addClass('visible');
	$('#Scene8_5').addClass('visible');
    $('#Scene8_6').addClass('visible');
	$('#Scene8_7').addClass('visible');
	$('#Scene8_8').addClass('visible');
	$('#Scene8_9').addClass('visible');
    $('#Scene8_10').addClass('visible');
	$('#Scene8_11').addClass('visible');
	$('#Scene8_12').addClass('visible');
	$('#Scene8_13').addClass('visible');
	$('#Scene8_14').addClass('visible');
    $('#Scene8_15').addClass('visible');
	$('#Scene8_16').addClass('visible');
	$('#Scene8_17').addClass('visible');
	$('#Scene8_18').addClass('visible');
	
/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide8_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide8_popup1').bind('touchend', function(event) {      
         document.getElementById('slide8_popup1').className='reset_slide8_popup1';
...
/*popup */
    $('#Sat').bind('touchend', function(event) {      
       $('#slide8_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide8_popup2').bind('touchend', function(event) {      
       document.getElementById('slide8_popup2').className='reset_slide8_popup2';

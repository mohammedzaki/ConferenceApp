$(document).ready(function () {     
    ...
    $('#Scene19_0').addClass('visible');
	$('#Scene19_1').addClass('visible');
	$('#Scene19_2').addClass('visible');
    $('#Scene19_3').addClass('visible');
	$('#Scene19_4').addClass('visible');
	$('#Scene19_5').addClass('visible');
    $('#Scene19_6').addClass('visible');
	$('#Scene19_7').addClass('visible');
	$('#Scene19_8').addClass('visible');
	$('#Scene19_9').addClass('visible');
	$('#Scene19_10').addClass('visible');
	$('#Scene19_11').addClass('visible');
	$('#Scene19_12').addClass('visible');
	$('#Scene19_13').addClass('visible');
	$('#Scene19_14').addClass('visible');
    $('#Scene19_15').addClass('visible');
	$('#Scene19_16').addClass('visible');


/*popup 1*/ 

    $('#Ref').bind('touchend', function(event) {      
       $('#slide19_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide19_popup1').bind('touchend', function(event) {      
       document.getElementById('slide19_popup1').className='reset_slide19_popup1';

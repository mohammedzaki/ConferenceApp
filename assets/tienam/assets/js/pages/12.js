$(document).ready(function () {     
    ...
    $('#Scene12_0').addClass('visible');
	$('#Scene12_1').addClass('visible');
	$('#Scene12_2').addClass('visible');
    $('#Scene12_3').addClass('visible');
	
	$('#Scene12_bar1').addClass('visible');
	$('#Scene12_bar2').addClass('visible');
	$('#Scene12_bar3').addClass('visible');
	$('#Scene12_bar4').addClass('visible');
	$('#Scene12_bar5').addClass('visible');
	$('#Scene12_bar6').addClass('visible');
	$('#Scene12_bar7').addClass('visible');
	$('#Scene12_bar8').addClass('visible');
	$('#Scene12_bar9').addClass('visible');
	$('#Scene12_bar10').addClass('visible');
	$('#Scene12_bar11').addClass('visible');
	$('#Scene12_bar12').addClass('visible');
	$('#Scene12_bar13').addClass('visible');
	$('#Scene12_bar14').addClass('visible');
	$('#Scene12_bar15').addClass('visible');
	$('#Scene12_bar16').addClass('visible');
	$('#Scene12_bar17').addClass('visible');
	$('#Scene12_bar18').addClass('visible');
	

/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide12_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide12_popup1').bind('touchend', function(event) {      
       document.getElementById('slide12_popup1').className='reset_slide12_popup1';
...
/*popup */
    $('#Sat').bind('touchend', function(event) {      
       $('#slide12_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide12_popup2').bind('touchend', function(event) {      
       document.getElementById('slide12_popup2').className='reset_slide12_popup2';

$(document).ready(function () {     
    ...
    $('#Scene23_0').addClass('visible');
	$('#Scene23_1').addClass('visible');
	$('#Scene23_2').addClass('visible');
    $('#Scene23_3').addClass('visible');
	$('#Scene23_4').addClass('visible');
	$('#Scene23_5').addClass('visible');
    $('#Scene23_6').addClass('visible');
	$('#Scene23_7').addClass('visible');

/*popup 1*/ 

    $('#Ref').bind('touchend', function(event) {      
       $('#slide23_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide23_popup1').bind('touchend', function(event) {      
       document.getElementById('slide23_popup1').className='reset_slide23_popup1';
...
/*popup */
    ...
    $('#Sat').bind('touchend', function(event) {      
       $('#slide23_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide23_popup2').bind('touchend', function(event) {      
       document.getElementById('slide23_popup2').className='reset_slide23_popup2';

$(document).ready(function () {     
    ...
    $('#Scene7_0').addClass('visible');
	$('#Scene7_1').addClass('visible');
	$('#Scene7_2').addClass('visible');
    $('#Scene7_3').addClass('visible');
	$('#Scene7_4').addClass('visible');
	$('#Scene7_4_1').addClass('visible');
	$('#Scene7_4_2').addClass('visible');
	$('#Scene7_4_3').addClass('visible');
	$('#Scene7_4_4').addClass('visible');
	$('#Scene7_4_5').addClass('visible');
	
	$('#Scene7_5').addClass('visible');
    $('#Scene7_6').addClass('visible');
	$('#Scene7_6_1').addClass('visible');
	$('#Scene7_6_2').addClass('visible');
	$('#Scene7_6_3').addClass('visible');
	$('#Scene7_6_4').addClass('visible');
	$('#Scene7_6_5').addClass('visible');
	
	$('#Scene7_7').addClass('visible');
	

/*popup 1*/
    $('#Ref').bind('touchend', function(event) {      
       $('#slide7_popup1').addClass('visible'); 
       $('#background_transparent1').addClass('visible');
       $('#background_Frame1').addClass('visible');
       return false;
     });
     $('#slide7_popup1').bind('touchend', function(event) {      
       document.getElementById('slide7_popup1').className='reset_slide7_popup1';
...
/*popup */
    $('#Sat').bind('touchend', function(event) {      
       $('#slide7_popup2').addClass('visible'); 
       $('#background_transparent2').addClass('visible');
       $('#background_Frame2').addClass('visible');
       return false;
     });
     $('#slide7_popup2').bind('touchend', function(event) {      
       document.getElementById('slide7_popup2').className='reset_slide7_popup2';
